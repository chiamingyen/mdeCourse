# -*- coding: utf-8 -*-
#@+leo-ver=4-thin
#@+node:amd_yen.20130308221230.2441:@shadow c2/generate_stud.py
#@@first
#@@language python
# 配合程式所使用的 @asis 會將資料存在 .leo 檔案
# 建立虛擬的班級人員名單
#@<< import >>
#@+node:amd_yen.20130308221230.3820:<< import >>
import random
import string
#@-node:amd_yen.20130308221230.3820:<< import >>
#@nl
...
'''
#@+others
#@+node:amd_yen.20130308221230.3821:@asis c2/lastname.txt
...
毋沙乜養鞠須豐巢關蒯相查後荊紅
#@-node:amd_yen.20130308221230.3821:@asis c2/lastname.txt
#@+node:amd_yen.20130308221230.3822:@asis c2/firstname.txt
