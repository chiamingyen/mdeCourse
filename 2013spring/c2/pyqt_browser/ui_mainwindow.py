#!/usr/bin/env python
#@+leo-ver=5-thin
#@+node:amd_yen.20130429214002.4039: * @file ui_mainwindow.py
#@@first
...
#@+<<declarations>>
#@+node:amd_yen.20130429214002.4040: ** <<declarations>> (ui_mainwindow)
import sys
from PyQt4 import QtCore, QtGui, QtWebKit
import mainwindow_rc
#@-<<declarations>>
#@+others
#@+node:amd_yen.20130429214002.4041: ** class QWebView2
class QWebView2(QtWebKit.QWebView):
    #@+others
    #@+node:amd_yen.20130429214002.4042: *3* __init__
    def __init__(self, parent=None):
        QtWebKit.QWebView.__init__(self, parent)
    #@+node:amd_yen.20130429214002.4043: *3* mouseDoubleClickEvent
    ...
    #@-others
#@+node:amd_yen.20130429214002.4044: ** class Ui_MainWindow
class Ui_MainWindow(object):
    #@+others
    #@+node:amd_yen.20130429214002.4045: *3* setupUi
    ...
    #@+node:amd_yen.20130429214002.4046: *3* createToolbars
    ...
    #@+node:amd_yen.20130429214002.4047: *3* createActions
