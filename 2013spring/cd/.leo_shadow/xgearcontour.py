#@+leo-ver=4-thin
#@+node:amd_yen.20130314194325.1747:@shadow cd/gearcontour.py
#coding: utf-8
'''正齒輪 2D 繪圖, 採用 Python3 tkinter 介面
'''
#@<< import >>
#@+node:amd_yen.20130314194325.1748:<< import >>
from tkinter import *
# 導入所有的數學函式
from math import *
#@nonl
...
#
#@+others
#@+node:amd_yen.20130314194325.1749:def gear()
# 定義一個繪正齒輪的繪圖函式
# midx 為齒輪圓心 x 座標
# midy 為齒輪圓心 y 座標
# rp 為節圓半徑, n 為齒數
...
#@nonl
#@-node:amd_yen.20130314194325.1749:def gear()
#@+node:amd_yen.20130314194325.1750:mainloop
#
# 以下為 tkinter 畫布繪圖主內容
#
frame=Frame()
