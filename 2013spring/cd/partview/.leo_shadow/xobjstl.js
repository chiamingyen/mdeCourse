//@+leo-ver=4-thin
//@+node:amd_yen.20130418193628.2123:@shadow cd/partview/objstl.js
//@<< comment >>
//@+node:amd_yen.20130418193628.2124:<< comment >>
// 將 document.body 換成 renderer.domElement, 讓零件控制只限於 domElement 視窗內
// 在	function ev_mousewheel(e)  增加 e.preventDefault(); 使得在 domElement 中的捲動只會縮放零件
// 本程式需要與 rev 48 的 Three.js, 以及 RequestAnimationFrame.js 配合
//@nonl
//@-node:amd_yen.20130418193628.2124:<< comment >>
//@nl
//@+others
//@+node:amd_yen.20130418193628.2125:main program
