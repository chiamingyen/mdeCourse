...
# 為了利用結巴套件進行中文分詞, 將中文分詞程式放在 exts 目錄中
...
# 使用 graphviz 延伸程式
extensions = ['sphinx.ext.graphviz', 'sphinx.ext.pngmath', 'sphinx.ext.mathjax']
...
release = '1.0'  # Using the short version is simplest and good.
