...
\setCJKmainfont[BoldFont=新細明體,Scale=1.1]{新細明體}
\setCJKsansfont[BoldFont=新細明體,Scale=1.1]{新細明體}
\punctstyle{marginkerning}
%\usepackage{fontspec}
%\defaultfontfeatures{Mapping=tex-text}
%\setmainfont[BoldFont=cwTeXHeiBold]{cwTeXFangSong}
%\setsansfont[BoldFont=cwTeXHeiBold]{cwTeXKai}
...
\tableofcontents
\renewcommand{\listfigurename}{圖形清單}
\listoffigures
\renewcommand{\listtablename}{表格清單}
\listoftables
